...
class _WaiterTableGridScreenState extends State<WaiterTableGridScreen> {
    ...
    return AppScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          // reach the kitchen/bar. Tap to review, then send or reject.
          if (state.pendingApprovalOrders.isNotEmpty) ...[
            const SizedBox(height: 12),
            GestureDetector(
              onTap: () => _showPendingApprovalSheet(context),
              child: Container(
                padding:
                    const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
                decoration: BoxDecoration(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        L.pendingApprovalN(state.pendingApprovalOrders.length),
  ...
  void _showPendingApprovalSheet(BuildContext context) {
