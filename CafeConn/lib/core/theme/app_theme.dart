...
class AppTheme {
  ...
  // Actions.
  static const cta = Color(0xFF221F1A); // Espresso

  // Status semantics.
  static const success = Color(0xFF3E9C63);
  static const warning = Color(0xFFE0823A); // Kitchen zone
  static const danger = Color(0xFFD9564A);
  static const bar = Color(0xFF3C7BCF); // Bar zone
...
class T {
  ...
  static const body = TextStyle(
      ...
      fontWeight: FontWeight.w400,
      color: AppTheme.ink);
  static const bodySemi = TextStyle(
      fontFamily: 'Inter',
      fontSize: 14,
      fontWeight: FontWeight.w600,
      color: AppTheme.ink);
  static const small = TextStyle(
      ...
      fontWeight: FontWeight.w400,
      color: AppTheme.ink2);
  static const smallSemi = TextStyle(
      fontFamily: 'Inter',
      fontSize: 12,
      fontWeight: FontWeight.w600,
      color: AppTheme.ink2);
